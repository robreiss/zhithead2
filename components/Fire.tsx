...
export default function Fire() {
  return (
    ...
    >
      <path
        className="[animation-duration:1.5s]"
        fill="#F36E21"
	...
	c6.806,41.899,16.831,45.301,6.088,53.985"
      />
      <path
        className="[animation-delay:0.5s] [animation-duration:2s]"
        fill="#F6891F"
	...
	c20.585,52.899-19.848,61.045-19.643,61.582c0.206,0.537-19.401-0.269-14.835-18.532S57.576,137.656,61.693,122.257z"
      />
      <path
        className="[animation-delay:1s] [animation-duration:0.9s]"
        fill="#FFD04A"
	...
	C84.858,184.21,125.705,150.905,81.657,79.192z"
      />
      <path
        className="[animation-delay:1.5s] [animation-duration:1.55s]"
        fill="#FDBA16"
	...
	S134.387,164.603,103.143,105.917z"
      />
      <path
        className="[animation-delay:2.5s] [animation-duration:1.25s]"
        fill="#FDBA16"
